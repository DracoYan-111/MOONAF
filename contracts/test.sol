...
contract CoinToken is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public prohibitedToSell;
    ...
    function _transfer(
        ...
        require(isItrunning, "ERC20: has not started");
        require(!prohibitedToSell[from], "ERC20: prohibited to sell");
